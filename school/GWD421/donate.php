<!DOCTYPE html>
<html><head><title>Donate</title>
<?php require "templates/header.php"; ?>
<section id="content" class="container padding_top_30 padding_bottom_30">
	<div class="row"><h1 class="col_12">Sorry...</h1>This feature is not yet available.</div>
	...
	<!--div class="row">
		...
		<form class="col_8" action="function_contact.php" method="POST">
			<table class="contact">
				<tr>
					<td colspan="3">Select you donation package</td>
				</tr>
		...
		<ul class="col_4 last no_bullet">
			...
			<li><strong>E-mail:  </strong>Africanartmuseum@aol.com</li>
			<li>
